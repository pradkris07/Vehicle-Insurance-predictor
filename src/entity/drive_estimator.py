...
class Proj2Estimator:
    """
    This class is used to save and retrieve our model from local area and to do prediction
    """
    ...
    def __init__(self,bucket_name,model_path,):
        ...
        self.model_path = model_path
        self.loaded_model:MyModel=None
        self.online_model_path = "./model.pkl"
    ...
    def predict_online(self,dataframe:DataFrame):
        ...
        try:
            if self.loaded_model is None:
                self.loaded_model = self.load_online_model()
            return self.loaded_model.predict(dataframe=dataframe)
        except Exception as e:
            raise MyException(e, sys)
    
    def load_online_model(self,)->MyModel:
        """
        Load the model from the model_path
        :return:
        """
